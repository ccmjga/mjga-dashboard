...
export interface paths {
	...
	"/department/all": {
		...
		get: operations["queryAllDepartments"];
		put?: never;
		post?: never;
		delete?: never;
		options?: never;
...
export interface operations {
	...
	upsertDepartment: {
		...
		requestBody: {
			content: {
				"application/json": components["schemas"]["DepartmentUpsertDto"];
			};
		};
		responses: {
			/** @description OK */
	...
	pageQueryDepartments: {
		...
		responses: {
			...
			200: {
				...
				content: {
					"*/*": components["schemas"]["PageResponseDtoListDepartment"];
				};
			};
		};
	};
